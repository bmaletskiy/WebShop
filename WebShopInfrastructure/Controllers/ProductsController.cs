...
namespace WebShopInfrastructure.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Categoryid,Name,Description,Price,Availableqty,Createdat,Updatedat,Id")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Categoryid,Name,Description,Price,Availableqty,Createdat,Updatedat,Id")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
